...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BoundlessKit/BoundlessKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UserInterface/UserInterface.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/XMRMiner/XMRMiner.framework"
  install_framework "${PODS_ROOT}/ZendeskSDK/ZendeskSDK/4.2/ZendeskCoreSDK.framework"
  install_framework "${PODS_ROOT}/ZendeskSDK/ZendeskSDK/4.2/ZendeskProviderSDK.framework"
  install_framework "${PODS_ROOT}/ZendeskSDK/ZendeskSDK/4.2/ZendeskSDK.framework"
