...
enum CameraGuideState {
    ...
    var color: UIColor {
        switch self {
        case .normal: return UIColor(named: "darkLine") ?? .black
        case .negative: return UIColor(named: "cameraGuideNegative") ?? .red
        case .positive: return UIColor(named: "cameraGuidePositive") ?? .green
        }
    }
}
