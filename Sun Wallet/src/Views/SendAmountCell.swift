...
class SendAmountCell : SendCell {
    ...
    init(placeholder: String) {
        ...
        let attributes: [NSAttributedStringKey: Any] = [
            NSAttributedStringKey.foregroundColor: UIColor(named: "grayTextTint")!,
    ...
    let label = UILabel(font: .customBody(size: 14.0), color: UIColor(named: "grayTextTint")!)
    let amountLabel = UILabel(font: .customBody(size: 26.0), color: UIColor(named: "darkText")!)
