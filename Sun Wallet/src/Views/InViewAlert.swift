...
class InViewAlert: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if type == .secondary {
            ...
            context?.setStrokeColor((UIColor(named: "secondaryShadow") ?? .black).cgColor)
    ...
    private var fillColor: UIColor {
        switch type {
        case .primary:
            return UIColor(named: "primaryButton") ?? .white
        case .secondary:
            return UIColor(named: "grayBackgroundTint") ?? .gray
        }
    }
