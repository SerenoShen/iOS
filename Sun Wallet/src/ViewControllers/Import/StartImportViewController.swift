...
class StartImportViewController : UIViewController {
    ...
    private let message = UILabel.wrapping(font: .customBody(size: 16.0), color: UIColor(named: "darkText")!)
    private let warning = UILabel.wrapping(font: .customBody(size: 16.0), color: UIColor(named: "darkText")!)
    ...
    private let leftCaption = UILabel.wrapping(font: .customMedium(size: 13.0), color: UIColor(named: "darkText")!)
    private let rightCaption = UILabel.wrapping(font: .customMedium(size: 13.0), color: UIColor(named: "darkText")!)
